...
void updateDisplay(int displayMode)
{
  ...
  switch (displayMode)
  {
    ...
    case DISPLAY_UPDATING:
      Serial.println("Updating BC24Weather Software");



      setDisplayLine(0,  "BC24Weather Updating");
      setDisplayLine(1, "");
      setDisplayLine(2, "");
      setDisplayLine(3, "");
      setDisplayLine(4, "");
    ...
    case DISPLAY_UPDATE_FINISHED:
      Serial.println("Finish BC24Weather Software");



      setDisplayLine(0,  "BC24Weather Updated");
    ...
    case DISPLAY_POWERUP:
      Serial.println("BC24Weather Booting Up");

      strcpy(buffer, "Ver: ");
      strcat(buffer, BC24ESP32VERSION);

      setDisplayLine(0,  "BC24Weather Booting");
    ...
    case  DISPLAY_ACCESSPOINT:
      {
        Serial.println("BC24Weather Setup");




        setDisplayLine(0,  "BC24Weather AP");
        buffer[0] = '\0';
...
#define WL_MAC_ADDR_LENGTH 6
    ...
    case  DISPLAY_FAILING_AP:
      {
        ...
        setDisplayLine(1, buffer);
        buffer[0] = '\0';
        setDisplayLine(2, "Restarting BC24Weather");
    ...
    case DISPLAY_IPDISPLAY:
      ...
      {
        setDisplayLine(0, "BC24Weather Connected");
